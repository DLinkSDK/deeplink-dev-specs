...
TODO: Add long description of the pod here.
  ...
  s.source          = { :http => "https://deeplink-dev-ios.s3.ap-southeast-1.amazonaws.com/ios-frameworks/AppAttribution/3.0.0/AppAttribution.xcframework.zip" }
