...
DESC
  ...
  s.source          = { :http => "https://deeplink-dev-ios.s3.ap-southeast-1.amazonaws.com/ios-frameworks/AnalyticsKit/2.3.0/AnalyticsKit.xcframework.zip" }
  ...
  s.dependency 'WCDB.swift', '2.1.16'
  s.dependency 'DLinkAuthKit', '>= 1.1.0'
